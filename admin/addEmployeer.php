...
<div class="container">
    ...
    <form action="realise/addEmployeer.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <textarea  class="form-control" placeholder="position" name="pos" required></textarea>
        </div>
